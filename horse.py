...
#Laurell's Notes Start Here
# Player1, Player2
# import random (input) determines whether player makes or misses shot
# Keep up with missed shots (H, O, R, S, E) updates players letters if missed
# If statements for miss/make shot
# Output is a Letter if shot is missed
# Value of score will change when shot missed (new letter)
# def shoot(player): (while function?)
